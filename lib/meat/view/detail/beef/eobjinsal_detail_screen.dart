                    ...
                    child: Padding(
                      ...
                      child: Text.rich(
                        TextSpan(
                          children: [
                            TextSpan(
                              text: '색다른 구이용 부위를 접하고 싶은 분께 추천해요.',
                              style: detailThinContentStyle,
                            ),
                          ],
                        ),
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            padding: EdgeInsets.symmetric(horizontal: 16.0),
            child: ChoosingYummyMeat(name: '업진살'),
          ),
          ...
          HorizontalImages(
            ...
            goodDescriptionsList: const [
              ['등급이 높은 것', '근육은 식감이 있어요', '적당한 지방 함량이 필요해요'],
            ],
            badDescriptionsList: const [
              ['등급이 낮은 것', '지방함량이 적은 것', '퍽퍽할 가능성이 커요'],
            ],
          )
        ],
      ),
